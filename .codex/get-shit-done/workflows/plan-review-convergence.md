...
```bash
INIT=$(node "/Users/isahamid/Documents/untitled folder/task-chat/untitled folder/untitled folder/personal-cloud-platform/.codex/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/Users/isahamid/Documents/untitled folder/task-chat/untitled folder/untitled folder/personal-cloud-platform/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/Users/isahamid/Documents/untitled folder/task-chat/untitled folder/untitled folder/personal-cloud-platform/.codex/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
