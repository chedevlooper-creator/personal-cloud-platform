...
- [x] Quick task 260501-automations: Automations UI quality pass
...
| 2026-05-01 | Automations UI quality pass | `/automations` list, tabs, actions, and run history tightened for responsive layout, touch targets, and Turkish interface text |
